...
export default component$(() => {
  ...
  return (
    <section
      ref={heroRef}
      id="hero"
      class="relative pt-16 lg:pt-32 min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950"
      role="banner"
